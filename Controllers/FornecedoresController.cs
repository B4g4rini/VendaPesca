...
namespace VendaPesca.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,NomeEmpresa,CNPJ,Endereco,Telefone,Email")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("FornecedorId,NomeEmpresa,CNPJ,Endereco,Telefone,Email")] Fornecedor fornecedor)
        {
